      ...
      {open && (
        <div className="fixed inset-0 z-[120] flex items-center justify-center p-4">
          ...
          <motion.div
            ...
            className={`relative w-full ${sizeMap[size]} bg-white rounded-2xl shadow-2xl border border-gray-100 overflow-hidden`}
            onClick={(e) => e.stopPropagation()}
          >
            {(title || showClose) && (
              <div className="flex items-center justify-between px-6 pt-6 pb-0">
                <div className="flex items-center gap-3">
                  {icon && <div className="p-2 rounded-lg bg-gray-100 text-gray-700">{icon}</div>}
