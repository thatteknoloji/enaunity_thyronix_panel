      ...
      {editing && (
        <div className="rounded-xl border border-ena-border bg-ena-card p-6 space-y-3">
          <div className="grid grid-cols-3 gap-3">
            <select value={form.moduleKey} onChange={e=>setForm({...form,moduleKey:e.target.value})} className="rounded-lg border border-ena-border bg-ena-dark px-3 py-2 text-sm text-ena-text"><option value="THYRONIX">THYRONIX</option><option value="HIVE">HIVE</option><option value="HIVE_PRO">HIVE Pro</option></select>
