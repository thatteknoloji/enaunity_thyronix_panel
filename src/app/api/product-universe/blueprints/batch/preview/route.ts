...
import { previewBlueprintBatch } from "@/lib/product-universe/blueprint-batch-engine";
...
export async function POST(req: Request) {
  try {
    ...
    const data = await previewBlueprintBatch(filters, {
    ...
    const msg = e instanceof Error ? e.message : "Batch preview başarısız";
