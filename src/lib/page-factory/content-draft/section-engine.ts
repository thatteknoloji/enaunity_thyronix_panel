...
const KIND_SECTIONS: Record<string, ContentDraftSectionType[]> = {
  ...
  PRODUCT_GUIDE: ["HERO", "QUICK_ANSWER", "BUYING_GUIDE", "USE_CASES", "FAQ", "CTA"],
  PRODUCT_BENEFIT: ["HERO", "QUICK_ANSWER", "FEATURE_GRID", "USE_CASES", "FAQ", "CTA"],
  PRODUCT_PROBLEM: ["HERO", "QUICK_ANSWER", "PRODUCT_SUMMARY", "FAQ", "CTA"],
  PRODUCT_COMPARISON: ["HERO", "QUICK_ANSWER", "COMPARISON", "FAQ", "CTA"],
  PRODUCT_ALTERNATIVE: ["HERO", "QUICK_ANSWER", "COMPARISON", "PRODUCT_SUMMARY", "CTA"],
