...
export const VARIANT_FIELD_ALIASES: Record<string, string[]> = {
  ...
  variantSku: ["variantsku", "variant_sku", "varyantsku", "varyant_sku", "sku", "stockcode", "stok_kodu", "productcode"],
  variantPrice: ["variantprice", "variant_price", "varyantfiyat", "varyant_fiyat", "price", "fiyat", "satisfiyati"],
