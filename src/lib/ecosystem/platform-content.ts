...
export const PLATFORM_CONTENT: Record<string, PlatformContent> = {
  ...
  "dropship": {
    slug: "dropship",
    name: "ENA Dropship",
    subtitle: "Dropship Mağaza Oluşturucu",
    description: "Kendi e-ticaret mağazanı dakikalar içinde aç. Hazır Ürün Deposu'ndan ürünleri seç, fiyatlandır, subdomain'inde satışa başla. Sepet ve sipariş yönetimi hazır; online ödeme entegrasyonu yakında.",
    icon: "Store",
    themeColor: "#f97316",
    accentColor: "#ef4444",
    badgeText: "YENİ",
    ...
    hero: {
      ...
      description: "Teknik bilgi gerektirmeden Hazır Ürün Deposu'ndan seçtiğin ürünlerle kendi mağazanı kur. Subdomain, sepet ve sipariş yönetimi hazır. Online ödeme ve kargo entegrasyonları yakında.",
    },
    problems: [
    ...
    solution: {
      ...
      description: "ENA Dropship ile ihtiyacın olan tek şey bir ENA hesabı ve modül lisansı. Mağazanı aç, Hazır Ürün Deposu'ndan ürünleri seç, kendi fiyatını belirle ve satmaya başla.",
    },
    features: [
      ...
      { title: "Ödeme (Yakında)", description: "Platform ve bayi ödeme modelleri planlandı. Şu an siparişler manuel ödeme akışıyla kaydedilir.", icon: "CreditCard" },
    ...
    faq: [
      ...
      { id: "ds-5", question: "Ödemeyi nasıl alıyorum?", answer: "Şu an siparişler mağazada kaydedilir; ödeme bayi tarafından sipariş sonrası alınır. Online ödeme entegrasyonu yakında.", sortOrder: 4, active: true },
      { id: "ds-6", question: "Kargoyu kim yapıyor?", answer: "Siparişler bayi panelinde yönetilir. Fulfillment merkezi entegrasyonu yakında.", sortOrder: 5, active: true },
